...
class TransformerEncoderLayer(nn.Module):
    ...
    def __init__(self, d_model, heads, d_ff, dropout, attention_dropout, activation):
        ...
        # ***** changed name of first below line and added two more layer_norms
    ...
    def forward(self, inputs, mask):
        ...
        """
        # ***** changed name of first below line and added the two other layer_norms
        input_norm = self.layer_norm_1(inputs)
        input_norm = self.layer_norm_2(input_norm)
